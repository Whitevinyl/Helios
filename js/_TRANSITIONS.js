...
SkipEvents = [
    ...
    function() { // TO THE PASSAGE // 5
        ...
        if (scene > 6) {
            paletteTo(shardCols,shardColsDark,t);
        }
    ...
    function() { // TO THE NIGHT // 6
        ...
        colourTo(masterCol,-20,-15,-10,1,t);
        colourTo(highPass,-20,0,0,0,t);
        colourTo(lowPass,-40,-30,20,0,t);
        colourTo(landCols[0],20,25,30,1,t);

        paletteTo(shardCols,shardColsLight,t);

        delayTo(rotateDest,"x",0,t,0); // vert
        delayTo(rotateDest,"y",0,t,0); // horiz

        delayTo(passageAlpha,"A",30,t,0);
        delayTo(floatSpeed,"y",0.1,t,0);
        ...
        automate(controllers[26],"y",-45,t,0);
        //automate(controllers[29],"y",20,t,0);
        Player[10].volume.rampTo(20,t);
        scene = 7;
    }
